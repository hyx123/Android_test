...
public class Menu_two extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        Log.e("v.getId()", String.valueOf(id));
        if (id == R.id.button1) {
    ...
    public PopupWindow showTipPopupWindow(final View anchorView, final View.OnClickListener onClickListener) {
        final View contentView = LayoutInflater.from(anchorView.getContext()).inflate(R.layout.pop_window2, null);
